        ...
        <div class="bg-purple-100 ">
            ...
            <div class="flex justify-center max-w-screen-xl py-12 mx-auto md:py-28">
                <div class="flex flex-col justify-center mx-12 md:w-3/5 md:ms-20 md:mx-0">
                    <h1 class="mb-8 text-4xl font-bold text-center text-gray-900  md:text-start font-car md:text-7xl">
    ...
    <section class="container p-8 mx-auto sales" id="sales">
        ...
        <div class="grid gap-4 md:grid-cols-3">
            ...
            <div
                ...
                <p>At Bro's CAR RENTAL, we believe that every journey begins with a dream...</p>
            </div>
            <!-- Box 2 -->
            <div
                class="p-4 transition-transform transform border rounded shadow box hover:scale-105 hover:shadow-lg hover:bg-gray-100">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <form action="{{ route('users.book', ['id' => $car->id]) }}" method="POST">
                                @csrf
                                <button class="px-2 py-1 text-white bg-blue-500 rounded-lg hover:bg-blue-800">Book
                                    Now</button>
                            </form>
        ...
        <body class="flex items-center justify-center min-h-screen bg-gray-100">
            <div class="flex flex-col mx-auto overflow-hidden bg-white rounded-lg shadow-lg md:flex-row">
                ...
                <div class="p-8 md:w-1/2">
                    ...
                    <p class="mb-4 text-gray-800">Get yourself a best quality car at a best rate quoted anytime.</p>
                    <p class="mb-6 text-gray-800">We are Nepal's Largest Car Rental Company. With hundreds of fleets and
